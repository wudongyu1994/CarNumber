...
public class MainActivity extends Activity implements OnClickListener {
    ...
    String sn;
    private Button buttonExit;//buttonActivation,buttonSelectPic,
...
//        buttonSelectPic.setOnClickListener(this);
    ...
    private void findViews() {
        buttonExit = (Button) findViewById(R.id.butclose);    //退出程序
        mCarNumber = (EditText) findViewById(R.id.et_car_number);
        videoReg = (Button) findViewById(R.id.videoReg);        //视频拍摄
//        customCameraButton = (Button) findViewById(R.id.customcamerabutton);	//
//        buttonActivation = (Button) findViewById(R.id.butactivation);	//程序激活
...
//		}else
        if (getResources()
            ...
            //视频识别入口
//			CreatDialog();
            Intent video_intent = new Intent(MainActivity.this, MemoryCameraActivity.class);
            if (Build.VERSION.SDK_INT >= 23) {
                CheckPermission checkPermission = new CheckPermission(MainActivity.this);
                if (checkPermission.permissionSet(PERMISSION)) {
