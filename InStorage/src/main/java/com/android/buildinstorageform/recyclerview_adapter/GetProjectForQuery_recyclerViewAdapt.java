...
public class GetProjectForQuery_recyclerViewAdapt extends RecyclerView.Adapter<GetProjectForQuery_recyclerViewAdapt.AddMaterialToProject_ViewHolder> {

    private ArrayList<Project_class> arrayList_project;
    ...
    public GetProjectForQuery_recyclerViewAdapt(ArrayList<Project_class> arrayList_material) {
        this.arrayList_project = arrayList_material;
    }
    ...
    public void onBindViewHolder(final AddMaterialToProject_ViewHolder holder, int position) {
        ...
        holder.id_recyclerViewAdapter.setText(arrayList_project.get(position).getId()+"");
        holder.materialName_recyclerViewAdapter.setText(arrayList_project.get(position).getName());
        holder.figureNumber_recyclerViewAdapter.setText(arrayList_project.get(position).getProjectNumber()+"");
