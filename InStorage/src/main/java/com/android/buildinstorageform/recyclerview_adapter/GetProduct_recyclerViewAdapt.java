...
public class GetProduct_recyclerViewAdapt extends RecyclerView.Adapter<GetProduct_recyclerViewAdapt.Product_ViewHolder> {
    ...
    public GetProduct_recyclerViewAdapt(ArrayList<ProductForQuery_class> arrayList_product) {
