...
public class GetMaterial_recyclerViewAdapt extends RecyclerView.Adapter<GetMaterial_recyclerViewAdapt.AddMaterialToProject_ViewHolder> {
    ...
    public GetMaterial_recyclerViewAdapt(ArrayList<Material_class> arrayList_material) {
    ...
    public class AddMaterialToProject_ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.checkBox_recyclerViewAdapter) {
                ...
                checkBox_recyclerViewAdapter.setChecked(!(checkBox_recyclerViewAdapter.isChecked()));
            ...
            if(arrayList_checkBoxSelected.contains(getLayoutPosition())){
                ...
                if(checkBox_recyclerViewAdapter.isChecked()){
